...
class Validator implements IValidator
{
    ...
    protected $aKnownRules = [
        'required' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Required@validate',
        'email' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Email@validate',
        'url' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Url@validate',
        'min' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Min@validate',
        'max' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Max@validate',
        'minLength' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\MinLength@validate',
        'maxLength' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\MaxLength@validate',
        'length' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Length@validate',
        'in' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\In@validate',
        'notin' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\NotIn@validate',
        'alphabet' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Alphabet@validate',
        'num' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Numeric@validate',
        'regex' => 'Apps\CM_GradeService\Lib\Form\Validator\Rule\Regex@validate',
    ];
